...
class Crawler:
        ...
        for image_info in rsp_data['imgs']:
            ...
            try:
                ...
                urllib.request.urlretrieve(
                    image_info['objURL'], './' + word + '/' + str(self.__counter) + str(suffix))
    ...
    def get_images(self, word='美女'):
        ...
        while pn < self.__amount:
            ...
            url = 'https://image.baidu.com/search/avatarjson?tn=resultjsonavatarnew&ie=utf-8&word=' + search + '&cg=girl&pn=' + str(
